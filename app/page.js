...
const MyProfile = ({ }) => {
  return (
    <div className="p-6 pb-80 flex flex-col">
      <Header subtitle={'Summary'}>
        My Profile
      </Header>
      <p>
        Hi, my name is Muhammad Hizwan Bin Zameri. I am a versatile professional with a strong foundation in UI/UX design, UI engineering, and software development. My career journey has allowed me to take on diverse roles, from UI/UX developer to business analyst, showcasing my ability to adapt and excel in dynamic environments. With a keen interest in innovation and technology, I have contributed to projects ranging from photo booth applications to industrial systems, employing tools like Next.js, Node.js, and Kotlin.
      </p>
      <br></br>
      <p>
...
const Reflection = ({ children }) => {
  return (
    <div className="relative mt-4 mb-10 flex flex-col w-full p-2 rounded-xl bg-white/10 border border-white/20">
      <Image
        aria-hidden
        src="/pen.svg"
        alt="pen"
      ...
      />
      <h1 className="font-medium text-sm mb-3">My Reflection  </h1>
...
const Header = ({ children, subtitle }) => {
  return (
    <>
      ...
      <span className="mt-2 mb-20 text-sm">
        {subtitle}
      </span>
    </>
  )
